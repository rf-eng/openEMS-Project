...
function ci_build {
    ...
    python setup.py build_ext -I$GITHUB_WORKSPACE/build_output/opt/openEMS/include -L$GITHUB_WORKSPACE/build_output/opt/openEMS/lib -R$GITHUB_WORKSPACE/build_output/opt/openEMS/lib
